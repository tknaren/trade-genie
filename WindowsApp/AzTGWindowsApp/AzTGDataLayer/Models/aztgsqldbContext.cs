...
{
    public partial class aztgsqldbContext : DbContext
    {
        public aztgsqldbContext()
        {
        }

        public aztgsqldbContext(DbContextOptions<aztgsqldbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:aztgsqlserver.database.windows.net,1433;Initial Catalog=aztgsqldb;Persist Security Info=False;User ID=aztgsqlserver;Password=N@ren123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
